...
import {getDayOfTime, convertTimestampToDate, convertDateTimeToString, convertVnTimeStringToDate} from "../../../components/utils.js"
  ...
  },
  {
    ...
    cellClassRules: {
      'highlight-cell': params => { if(params.data.NgayNopHoSoDayDu && params.data.NgayDeNghiDauNoi){
        ...
        return getDayOfTime(convertVnTimeStringToDate(ngayNopHoSoDayDu), convertVnTimeStringToDate(ngayDeNghiDauNoi)) > 1;}
      }
    },
  },
  {
    ...
    cellClassRules: {
      'highlight-cell': params => { if(params.data.NgayChuyenVePKT && params.data.NgayNopHoSoDayDu){
        ...
        return getDayOfTime(convertVnTimeStringToDate(firstDay), convertVnTimeStringToDate(nextDay)) > 1;}
      }
    },
  },
  {
